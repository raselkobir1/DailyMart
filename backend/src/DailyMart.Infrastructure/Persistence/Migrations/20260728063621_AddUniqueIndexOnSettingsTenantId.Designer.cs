...
namespace DailyMart.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260728063621_AddUniqueIndexOnSettingsTenantId")]
    partial class AddUniqueIndexOnSettingsTenantId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DailyMart.Domain.Billing.Plan", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("DailyMart.Domain.Billing.SubscriptionPayment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("PlanId")
                        .HasDatabaseName("ix_subscription_payments_plan_id");
            ...
            modelBuilder.Entity("DailyMart.Domain.Billing.TenantSubscription", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("DailyMart.Domain.Rbac.Menu", b =>
                {
                    ...
                    b.Property<bool>("IsGenerallyAvailable")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                        .HasColumnName("is_generally_available");
            ...
            modelBuilder.Entity("DailyMart.Domain.Rbac.TenantFeatureGrant", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_tenant_feature_grants");

                    b.HasIndex("MenuId")
                        .HasDatabaseName("ix_tenant_feature_grants_menu_id");

                    b.HasIndex("TenantId", "MenuId")
                        .IsUnique()
                        .HasDatabaseName("ix_tenant_feature_grants_tenant_id_menu_id")
                        .HasFilter("is_deleted = false");

                    b.ToTable("tenant_feature_grants", (string)null);
                });
            ...
            modelBuilder.Entity("DailyMart.Domain.Billing.SubscriptionPayment", b =>
                {
                    b.HasOne("DailyMart.Domain.Billing.Plan", null)
                        .WithMany()
                        .HasForeignKey("PlanId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_subscription_payments_plans_plan_id");
                    ...
                    b.HasOne("DailyMart.Domain.Tenancy.Tenant", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_subscription_payments_tenants_tenant_id");
                });
            ...
            modelBuilder.Entity("DailyMart.Domain.Rbac.TenantFeatureGrant", b =>
                {
                    b.HasOne("DailyMart.Domain.Rbac.Menu", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_tenant_feature_grants_menus_menu_id");
                    ...
                    b.HasOne("DailyMart.Domain.Tenancy.Tenant", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_tenant_feature_grants_tenants_tenant_id");
                });
