...
/// cref="Tenancy.Tenant"/>, <see cref="Tenancy.PlatformAdmin"/>, <see cref="Rbac.Menu"/>, and the
/// Plan/TenantSubscription/SubscriptionPayment billing entities) - every other entity inherits
