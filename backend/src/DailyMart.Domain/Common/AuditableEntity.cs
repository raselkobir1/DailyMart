...
/// cref="Tenancy.Tenant"/>, <see cref="Tenancy.PlatformAdmin"/>, <see cref="Rbac.Menu"/>) - every
/// other entity inherits <see cref="TenantOwnedEntity"/> instead, which adds TenantId.
/// </summary>
